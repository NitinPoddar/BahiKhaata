...
observeEvent(input$ProductSubmit, {
    ...
    ImageData(input$ProductImage1,"www/",paste0(input$ProductID,"_",input$ProductName,"_1"))
    ImageData(input$ProductImage2,"www/",paste0(input$ProductID,"_",input$ProductName,"_2"))
    ImageData(input$ProductImage3,"www/",paste0(input$ProductID,"_",input$ProductName,"_3"))
    ImageData(input$ProductImage4,"www/",paste0(input$ProductID,"_",input$ProductName,"_4"))

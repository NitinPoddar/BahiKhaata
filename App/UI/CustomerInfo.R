                                  bsModal("CustomerPopUp", "Customer Details",trigger="CustomerAdd",size="small",
                                          div(
                                            id = "Customerform",
                                            actionBttn( inputId = "CustomerDelete", label = "Delete", color = "danger", style = "simple",size='sm' ),
                                            numericInput("CustomerID","ID*:",value=""),
                                            ...
                                            actionBttn( inputId = "CustomerSubmit", label = "Submit", color = "success", style = "gradient",size='sm' )
                                          ))
